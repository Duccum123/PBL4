...
<html>
    ...
    <body>
        ...
        <h1 class="content-payment-header">
            Thanh toán <span style="color: rgba(255, 96, 96, 1);" >650.000 VND</span> để xác nhận đặt vé
        </h1>
        ...
        <div class="content-payment-body">
                ...
                <div class="lable-ticket" style="margin-left: 0; width: 100%;">
                    ...
                    <div class="lable-customer-info">
                        ...
                        <div class="lable-customer-info-content">
                            <div class="customer-info-content-item" style="color: var(--black-color);">Tên: Trần Đăng Minh Đức</div>
                    ...
                    <div class="lable-ticket-contact">
                        <div class="lable-ticket-contact-left">
                            Vé điện tử sẽ được gửi qua Email: 
                        </div>

                        <div class="lable-ticket-contact-right">
                            minhduc07042004@gmail.com
                        </div>
                    </div>
                </div>

                <div class="option-payment">
                    <div class="option-payment-header">
                        ...
                        <div class="option-payment-item">
                            ...
                            <div class="payment-item-left">
                                ...
                                <div class="payment-item-text">
                                    <p class="payment-item-text-header">
                                        VNPAY
                                    </p>
                                    <p class="payment-item-text-desc">
                                        Thanh toán tức thì với VNPAY
                                    </p>
                                </div>
                            </div>
                            <div class="payment-item-right">
                                <img src="imgs/icon-payment.png" alt="" class="payment-item-icon-right">
                            </div>
                        </div>
            ...
            <div class="payment-body-right">
                ...
                <button class="login-btn login-btn--back cancel-ticket" onclick="BackPage()">Quay lại</button>
