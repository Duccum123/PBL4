        ...
        <div id="content-booking">
            <div id="content-booking-left">
                ...
                <div id="input-booking-wrap">
                    <div class="wrap-input input-bookingProcess">
                        <input list="cities" class="input-info" name="start-city" placeholder="Thành phố/ Tỉnh xuất phát">
                    </div>

                    <div class="wrap-input input-bookingProcess">
                        <input list="cities" class="input-info" name="start-city" placeholder="Thành phố/ Tỉnh đích đến">
                    </div>
                    <div class="wrap-input input-bookingProcess">
                ...
                <div class="content-left-ads">
                    ...
                    <div class="ads-text">
                        ...
                        <img class="icon-ads" src="imgs/icon-ads.png" alt="">
                    </div>
                </div>
                ...
                <p class="text-desc">
                    Hãy trải nghiệm dịch vụ đặt vé trực tuyến của chúng tôi, nơi bạn có thể chọn hành trình mong muốn chỉ với vài cú click. Tiết kiệm thời gian, không cần xếp hàng chờ đợi, đặt vé ngay bây giờ và nhận ưu đãi hấp dẫn!
                </p>
            ...
            <div id="content-booking-right">
                <div id="booking-right-header">
                    <h1 class="booking-content-header" style="color: var(--black-color);">
                        Các Chuyến Tàu
                    </h1>
                    <p class="text-desc" style="margin: 26px 0 0 30px;">
                        5 chuyến tàu
                    </p>
                </div>
                        ...
                        <div class="booking-label">
                            ...
                            <div class="lable-info-bonus">
                                <div class="lable-info-bonus-left">
                                    <p>Các ga đi qua:</p>
                                    <div class="info-bonus-left-result">
                                        Huế, Vinh, Thanh Hóa, Ninh Bình
                                    </div>
                                </div>
                ...
                <div class="modal__body body-option-3A">
                    <div class="auth-form-option auth-form-option-3A "> 
                        <div class="auth-form-option-container">
                            ...
                            <div class="option-body" style="background-color: rgba(208, 255, 200, 1);">
                            ...
                            <div class="option-desc">
                                <div class="option-desc-item">
                                    <div class="option-chair-item">
                                        ...
                                        <div class="item-square color-chair-soldout" style=" cursor: default;" >
                                ...
                                <div class="option-desc-item">
                                    <div class="option-chair-item">
                                        ...
                                        <div class="item-square color-chair-hold" style=" cursor: default;">
                            ...
                            <div class="box-btn">
                                <button class="login-btn" onclick="GoNextPage()">Tiếp tục</button>
                                <button class="login-btn login-btn--back" onclick="ExitOption_3A()">Trở lại</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal__body body-option-2A">
                    <div class="auth-form-option auth-form-option-3A "> 
                        <div class="auth-form-option-container">
                            ...
                            <div class="option-body" style="background-color: rgba(255, 233, 200, 1);">
                                <div class="option-body-left">
                            ...
                            <div class="box-btn">
                                <button class="login-btn" onclick="GoNextPage()">Tiếp tục</button>
                                <button class="login-btn login-btn--back" onclick="ExitOption_2A()">Trở lại</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal__body body-option-1A">
                    <div class="auth-form-option auth-form-option-3A "> 
                        <div class="auth-form-option-container">
                            ...
                            <div class="option-body" style="background-color: rgba(255, 205, 205, 1);">
                                <div class="option-body-left">
                            ...
                            <div class="box-btn">
                                <button class="login-btn" onclick="GoNextPage()">Tiếp tục</button>
                                <button class="login-btn login-btn--back" onclick="ExitOption_1A()">Trở lại</button>
                            </div>
                        </div>
                    </div>
                </div>
