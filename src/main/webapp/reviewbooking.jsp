...
<html>
    ...
    <div id="content-reviewbooking">
        <h1 class="content-reviewbooking-header">
            Thông tin đặt vé
        </h1>
        ...
        <div id="wrap-body">
            <div id="wrap-body-left">
                <div class="wrap-lable-info-user">
                    <div class="wrap-lable-info-user-title">
                        Thông tin chi tiết
                    </div>

                    <div class="wrap-input-info">
                        <input type="text" class="input-info-review" style="width: 60%;" placeholder="Họ và Tên">
                        <input type="number" class="input-info-review" style="width: 10%;" placeholder="Tuổi">
                        <input type="text" class="input-info-review" style="width: 10%;" placeholder="Giới tính">
                    </div>
                </div>

                <div class="wrap-lable-info-user">
                    <div class="wrap-lable-info-user-title wrap-lable-info-user-title-last">
                        Thông tin liên lạc
                    </div>

                    <div class="wrap-input-info">
                        <input type="number" class="input-info-review" style="width: 45%;" placeholder="Số điện thoại">
                        <input type="email" class="input-info-review" style="width: 45%;" placeholder="Email">
                    </div>
                </div>

                <div id="body-food">
                    <div class="wrap-food">
                        <img src="imgs/food-1.png" alt="">
                        <span class="name-food">Bát cơm Paneer Tikka 
                            <br>
                            - Nhỏ</span>
                        <span class="price-food">100.000 VND</span>
                        <div class="box-btn">
                            <button class="login-btn login-btn--back icon-food delete-food" style="height: 30px;">-</button>
                            <button class="login-btn icon-food add-food" style="height: 30px;">+</button>
                        </div>
                    </div>

                    <div class="wrap-food">
                        <img src="imgs/food-2.png" alt="">
                        <span class="name-food">Cơm chiên rau củ thập cẩm với trái cây khô</span>
                        <span class="price-food">119.000 VND</span>
                        <div class="box-btn">
                            <button class="login-btn login-btn--back icon-food delete-food" style="height: 30px;">-</button>
                            <button class="login-btn icon-food add-food" style="height: 30px;">+</button>
                        </div>
                    ...
                    <div class="wrap-food">
                        <img src="imgs/food-3.png" alt="">
                        <span class="name-food">Bột sữa đông Aloo Paratha (2 miếng)</span>
                        <span class="price-food">139.000 VND</span>
                        <div class="box-btn">
                            <button class="login-btn login-btn--back icon-food delete-food" style="height: 30px;">-</button>
                            <button class="login-btn icon-food add-food" style="height: 30px;">+</button>
                        </div>
                    ...
                    <div class="wrap-food">
                        <img src="imgs/food-3.png" alt="">
                        <span class="name-food">Bột sữa đông Aloo Paratha (2 miếng)</span>
                        <span class="price-food">109.000 VND</span>
                        <div class="box-btn">
                            <button class="login-btn login-btn--back icon-food delete-food" style="height: 30px;">-</button>
                            <button class="login-btn icon-food add-food" style="height: 30px;">+</button>
                        </div>
            ...
            <div id="wrap-body-right">
                <div class="lable-ticket">
                    ...
                    <div class="info-train-chair">
                        <div class="name-train">
                            12340 - SE1
                        </div>
                        <div class="name-chair">
                            3A & 20
                        </div>
                    </div>
                ...
                <button class="login-btn book-ticket" onclick="GoNextPage()">Đặt ngay</button>
                <button class="login-btn login-btn--back cancel-ticket" onclick="BackPage()">Hủy</button>
            </div>
        </div>

        <div id="content-reviewbooking-footer">
            <span class="review-footer-text">Chính sách hủy bỏ</span>
            <span class="review-footer-text">Điều khoản & Điều kiện</span>
            <span class="review-footer-text">Bảo hiểm du lịch</span>
        </div>
        ...
        <div class="footer-wrap">
            <div class="footer-content">
                ...
                <div class="footer-desc">
                    ...
                    <p class="desc-detail">Đăng ký nhận bản tin của chúng tôi. Nhận xu hướng và ưu đãi du lịch mới nhất!
                    </p>
                </div>
                    ...
                    <div class="auth-form__container">
                        ...
                        <div class="auth-form__aside">
                            <p class="auth-form__policy-text">
                                <span>Bằng việc đăng kí, bạn đã đồng ý với Shoppee về</span>
                                <span style="color: var(--primary-color);">Điều khoản và dịch vụ</span>
                                <span>&</span>
                                <span style="color: var(--primary-color);">Chính sách bảo mật</span>
                            </p>
                        </div>
                        <div class="box-btn">
                            <button class="login-btn">ĐĂNG KÍ</button>
                            <button class="login-btn login-btn--back" onclick="Back()">TRỞ LẠI</button>
                        </div>
                    </div>
                </div>
            </div>
